/**
 * DarkForge a Forge Hacked Client Copyright (C) 2017  Hexeption (Keir Davis)
 *
...
public final class MinecraftFontRenderer extends BasicFontRenderer {
    ...
    public int drawString(String text, int x, int y, int color, boolean shadow, float z) {
        ...
        GlStateManager.color4f((float) (color >> 16 & 255) / 255.0F, (float) (color >> 8 & 255) / 255.0F, (float) (color & 255) / 255.0F, alpha);
        ...
        for (int i = 0; i < size; i++) {
            ...
            if (character == '\247' && i < size && i + 1 < size) {
                ...
                if (colorIndex < 16) { // coloring
                    ...
                    GlStateManager.color4f((float) (colorcode >> 16 & 255) / 255.0F, (float) (colorcode >> 8 & 255) / 255.0F, (float) (colorcode & 255) / 255.0F, alpha);
